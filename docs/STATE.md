...
- **Версия:** 0.3.0
- **Текущая фаза:** Завершение базовой архитектуры: реализована поддержка MCP серверов, Security Interceptor, и скриптовых скиллов (Progressive Disclosure) для агентов.
- **Ключевые компоненты:**
