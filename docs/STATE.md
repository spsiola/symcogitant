...
- **Версия:** 0.4.1
- **Текущая фаза:** Повышение стабильности: реализован умный карантин (Smart Quarantine) моделей, fallback retry-циклы в сессиях, улучшена подпись телеграм-бота (детальная инфа о модели и токенах).
- **Ключевые компоненты:**
